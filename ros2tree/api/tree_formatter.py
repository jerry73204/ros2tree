class TreeFormatter:
    ...
    def __init__(self, use_unicode=True, show_prefixes=False):
        ...
        if show_prefixes:
            self.symbols.update(
                {"topic": "topic: ", "node": "node: ", "namespace": "ns: ", "publisher": "pub: ", "subscriber": "sub: "}
            )
        else:
            self.symbols.update(
                {"topic": "", "node": "", "namespace": "", "publisher": "↑ publishes: ", "subscriber": "↓ subscribes: "}
            )
    ...
    def _format_tree_recursive(
        ...
        for i, (key, value) in enumerate(items):
            ...
            if isinstance(value, dict) and "_topic_info" in value:
                ...
                # This is a namespace/directory, but check if it also has a topic
